...
_DOC2_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 156,  # num of samples in images/training
        'val': 42,  # num of samples in images/validation
    },
    num_classes=4, # classes(3) + ingore_label(1)
    ignore_label=255,
)
